 ...
 * {@hide}
 */
public class Exynos5260RIL extends RIL {
    ...
    public Exynos5260RIL(Context context, int networkMode, int cdmaSubscription) {
        this(context, networkMode, cdmaSubscription, null);
    }

    public Exynos5260RIL(Context context, int preferredNetworkType,
